...
search_failure_report_threshold = 10

#You need a twilio account
twilio_account_sid = 'ADD_YOUR_ACCOUNT_SID'
twilio_auth_token = 'ADD_YOUR_AUTH_TOKEN'
twilio_source_phone_number = '+44XXXXXXXXXX' #Add Twilio number
twilio_target_phone_number = '+44XXXXXXXXXX' #Add destination number
